<div align="center">
  <h2><b>Awesome Books with ES6</b></h2>
</div>
...
**Summit Website** is a personal project about how to implement ES6 syntax in various projects.
...
- **Dynamic Pages:** This project has three dynamic pages: Add, List and contact pages.

<p align="right">(<a href="#readme-top">back to top</a>)</p>

## 🚀 Live Demo <a name="live-demo"></a>

- [Live Demo Link](https://adams-ghub.github.io/awesome-books-es6/)
...
<ol>
    ...
    <li>Run the command "git clone git@github.com:Adams-Ghub/awesome-books-es6" in the terminal or command line</li>
...
To run the project, following method:
...
I would like to acknowledge and thank the following people Microverse for their great support in carrying out this project.
...
- **How do I save to the local storage**

  - By using the localStorage.setItem() 

- **How do I remove from the local storage of the browser**

  - By using localStorage.getItem()
